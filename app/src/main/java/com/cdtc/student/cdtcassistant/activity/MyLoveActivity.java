...
public class MyLoveActivity extends BaseTopActivity {
    ...
    private class MyLoveAdapter extends RecyclerView.Adapter<MyLoveHolder> {
        ...
        public void removeItem(int position) {
            myLoves.remove(position);
            notifyItemRemoved(position);
            notifyItemRangeChanged(position, myLoves.size() - position);
        }
    }
    ...
    private class MyLoveHolder extends RecyclerView.ViewHolder {
        ...
        private LinearLayout myLoveRoot;
        ...
        private void initView(View view) {
            ...
            myLoveRoot = view.findViewById(R.id.my_love_root);

            myLoveRoot.setOnLongClickListener(v -> {
                Integer position = getAdapterPosition();
                String loveId = myLoves.get(position).getId();
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(activity)
                        ...
                        .setNegativeButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                OkHttpUtil.doGet(Api.DELETE_LOVE + "?id=" + loveId, new Callback() {
                                    @Override
                                    public void onFailure(Call call, IOException e) {
                                        Log.d(TAG, "onFailure: " + e.getMessage());
                                        runOnUiThread(() -> {
